...
export const TAB_DESCRIPTIONS: Record<TabType, string> = {
  ...
  github: 'Manage your agency clients',
  gitlab: 'Browse your created dashboards',
  netlify: 'Configure your agency branding',
  vercel: 'Manage account, plans, and billing',
